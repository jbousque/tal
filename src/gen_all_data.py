    ...
    for f in ['f1', 'f2', 'f3']:
        ...
        for phase in ['train', 'dev', 'test']:
            ...
            if lang == 'fr':
                ...
                conllu_name = "..\\UD_French-GSD\\fr_gsd-ud-{phase}.conllu".format(phase=phase)
            
            elif lang == 'nl':
            
                conllu_name = "..\\UD_Dutch-LassySmall\\nl_lassysmall-ud-{phase}.conllu".format(phase=phase)
                
            elif lang == 'en':
                
                conllu_name = "..\\UD_English-LinES\\en_lines-ud-{phase}.conllu".format(phase=phase)
                
            elif lang == 'ja':
                
                conllu_name = "..\\UD_Japanese-GSD\\ja_gsd-ud-{phase}.conllu".format(phase=phase)
